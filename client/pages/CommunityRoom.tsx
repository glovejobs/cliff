            ...
            <div className="flex flex-col justify-end items-start gap-6 h-full">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center justify-between w-full max-w-[525px]">
                  ...
                  <div className="flex items-center gap-2">
                    <button className="flex items-center gap-2 px-2 py-2 rounded-lg border border-brand-primary bg-brand-primary text-brand-text text-xs font-medium">
                      Next scene
                    </button>
                    <button className="flex items-center gap-2 px-2 py-2 rounded-lg border border-brand-primary bg-brand-primary text-brand-text text-xs font-medium">
                      Redo
                    ...
                    <button className="flex items-center gap-2 px-2 py-2 rounded-lg border border-text-neutral-tertiary bg-surface-neutral text-text-dark text-xs font-medium">
