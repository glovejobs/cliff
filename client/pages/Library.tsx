      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col">
          <h4 className="text-text-primary text-sm font-bold leading-5">
            {title.includes("Time")
              ? "James Bond's Death"
              : title.includes("Skywalker")
                ? "Rey's Heritage Revelation"
                : "Rushed Final Season"}
          </h4>
        </div>
  ...
  const mediaItems = [
    {
      ...
      backgroundImage:
        "https://api.builder.io/api/v1/image/assets/TEMP/3c5ea0d6416506e14069be6ab0c53d1103f00a79?width=845",
      posterImage:
        "https://api.builder.io/api/v1/image/assets/TEMP/f5418c276cc60ca0f580ff926769520c6081d9f5?width=150",
      tag: "Action",
    ...
    },
    {
      ...
      backgroundImage:
        "https://api.builder.io/api/v1/image/assets/TEMP/6b0bcedf19ff5df5863236c7193d35137278ff79?width=845",
      posterImage:
        "https://api.builder.io/api/v1/image/assets/TEMP/9012f6a40fcfcf1cef4527330fccdc70779fb621?width=150",
      tag: "Sci-Fi",
    ...
    },
    {
      ...
      subtitle: "This week",
      description:
        "Arya and Tyrion share a quiet moment in the crypts of Winterfell. Surrounded by the dead, they discuss vengeance, legacy, and the cost of survival. Arya questions whether peace is ever real, while Tyrion wonders if monsters are born or made. A raven screeches overhead, signaling change.",
      backgroundImage:
        "https://api.builder.io/api/v1/image/assets/TEMP/6a7a1a4168e8ba99c0fbdf0f466e70f4c8041573?width=845",
      posterImage:
        "https://api.builder.io/api/v1/image/assets/TEMP/e76d9178f177e867e2f94d09e6f0dcf508dcf5b6?width=150",
      tag: "Fantasy",
