        ...
        <div className="flex-1 flex gap-12">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              />
              <p className="text-text-secondary text-base font-normal italic leading-6" style={{ fontFamily: 'Inter, -apple-system, Roboto, Helvetica, sans-serif' }}>
                Note: The name you choose will be how the character is referred to in scripts, so choose a name that helps keep our character list organized
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              />
              <p className="text-text-secondary text-base font-normal leading-6" style={{ fontFamily: 'Inter, -apple-system, Roboto, Helvetica, sans-serif' }}>
                What are their quirks, goals, and biggest secrets? What defining moments from their past shaped who they are today?
              </p>
            </div>
          ...
          <div className="flex-1 flex flex-col justify-center items-center bg-nav-bg rounded-2xl">
            {isGenerating ? (
              <div className="flex flex-col items-center gap-4">
                ...
                <span className="text-text-primary text-base">Generating character...</span>
              </div>
            ) : (
