...
const CommunityCard = ({
  ...
  return (
    <div className={`group relative flex flex-col justify-end items-start ${cardHeight} min-w-[194.4px] max-w-[265px] p-3 gap-3 rounded-2xl bg-[#232424] overflow-hidden cursor-pointer flex-1`}>
      ...
      <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 linear">
        <div className="flex items-center justify-center w-8 h-8 bg-[#2C2C2C] border border-[#2C2C2C] rounded-lg">
