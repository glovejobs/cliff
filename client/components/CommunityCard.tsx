...
const CommunityCard = ({
  ...
  return (
    <div
      className={`group relative flex flex-col justify-end items-start ${cardHeight} min-w-[194.4px] max-w-[265px] p-3 gap-3 rounded-2xl bg-[#232424] overflow-hidden cursor-pointer flex-1`}
    >
      {/* Background Image */}
      <img
        src={image}
      ...
      <div className="absolute bottom-3 left-3 right-3 z-10 flex justify-end items-end w-full group-hover:opacity-0 transition-opacity duration-200 linear">
        <div className="flex items-center gap-1 p-0.5 rounded-lg">
          ...
          <span
            className="text-[#F5F5F5] text-[11px] font-normal leading-4 tracking-[0.5px]"
            style={{
              fontFamily:
      ...
      <div className="absolute bottom-3 left-3 right-3 z-10 flex justify-between items-end w-full opacity-0 group-hover:opacity-100 transition-opacity duration-200 linear">
        ...
        <div className="flex items-center gap-[6.5px] rounded-[4.3px]">
          ...
          <div className="flex flex-col justify-center items-start gap-[1.1px]">
            <div
              className="text-[#F5F5F5] text-[9px] font-bold leading-[140%]"
              style={{
                fontFamily:
            ...
            <div
              className="text-[#757575] text-[8px] font-normal leading-[140%]"
              style={{
                fontFamily:
                  "Inter, -apple-system, Roboto, Helvetica, sans-serif",
              }}
